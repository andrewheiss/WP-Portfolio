...
function addAdminMenu() {
	add_menu_page('Portfolio Settings', 'Portfolio', 8, __FILE__, 'portfolioOptions');
	add_submenu_page(__FILE__, 'Portfolio settings', 'Settings', 8, __FILE__, 'portfolioOptions');
	add_submenu_page(__FILE__, 'Edit Portfolio Entries', 'Edit Portfolio Entries', 8, 'portfolio-edit', 'editEntries');	
}
